...
Clean public archive for an FPGA signal-processing project using a Nios II/Qsys system, DDS waveform generation, LFSR data generation, modulation concepts, VGA-style visualization, keyboard input, and C software running alongside custom HDL.
...
- `docs/` - project PDFs and preserved documentation.
...
2. Refresh Platform Designer files from `rtl/qsys/` if the generated system needs rebuilding.
...
This repository keeps the source trail and design evidence while excluding generated reports, compiled images, BSP build outputs, and simulator caches.
